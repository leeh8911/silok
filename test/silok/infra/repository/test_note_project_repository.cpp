...
class NoteProjectRepositoryTest : public ::testing::Test
{
protected:
    void SetUp() override
    {
...
TEST_F(NoteProjectRepositoryTest, CRUD)
{
    silok::infra::repository::NoteProjectRepository repo;
    silok::domain::NoteProject rel{0, 1, 2};
