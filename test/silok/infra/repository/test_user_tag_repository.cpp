...
class UserTagRepositoryTest : public ::testing::Test
{
protected:
    void SetUp() override
    {
...
TEST_F(UserTagRepositoryTest, CRUD)
{
    silok::infra::repository::UserTagRepository repo;
    silok::domain::UserTag rel{0, 1, 2};
