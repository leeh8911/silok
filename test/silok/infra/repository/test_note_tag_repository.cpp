...
class NoteTagRepositoryTest : public ::testing::Test
{
protected:
    void SetUp() override
    {
...
TEST_F(NoteTagRepositoryTest, CRUD)
{
    silok::infra::repository::NoteTagRepository repo;
    silok::domain::NoteTag rel{0, 1, 2};
