...
class UserNoteRepositoryTest : public ::testing::Test
{
protected:
    void SetUp() override
    {
...
TEST_F(UserNoteRepositoryTest, CRUD)
{
    silok::infra::repository::UserNoteRepository repo;
    silok::domain::UserNote rel{0, 1, 2};
