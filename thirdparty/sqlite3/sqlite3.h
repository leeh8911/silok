...
#define SQLITE_COPY 0                /* No longer used */
    ...
    */
    ...
    SQLITE_API SQLITE_EXPERIMENTAL void *sqlite3_profile(
...
#define SQLITE_TRANSIENT ((sqlite3_destructor_type) - 1)
    ...
    */
    ...
    SQLITE_API int sqlite3_create_collation16(sqlite3 *, const void *zName, int eTextRep,
                                              void *pArg,
                                              int (*xCompare)(void *, int, const void *, int,
                                                              const void *));
...
#define SQLITE_STMTSTATUS_AUTOINDEX 3
    ...
    */
    SQLITE_API void *sqlite3_wal_hook(sqlite3 *, int (*)(void *, sqlite3 *, const char *, int),
                                      void *);
